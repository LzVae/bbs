	...
	<div id="bgp">
		...
		<div id="left-nav">
			<ul class="nav navbar-default nav-stacked " style="width: 85%">
				<li><a href="newwelcome.jsp">全部动态</a></li>
				<li><a href="my_newwelcome.jsp"  class="list-group-item moduleItemLeft active">我的动态</a></li>
		...
		<div id="main-info">
			...
			<div id="input-text">
				<form action="publishMessage" method="post">
					<textarea  class="form-control" style="min-height: 82px;" id="saysomething" required="">说点什么吧</textarea>
